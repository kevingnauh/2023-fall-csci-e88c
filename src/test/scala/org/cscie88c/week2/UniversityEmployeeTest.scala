    ...
    "instantiated" should {
      "have a name property" in {
        new UniversityEmployee(
          "Mike Stone",
          "mstone@harvard.edu"
        ).name should be("Mike Stone")
        new UniversityEmployee("Kevin Huang", "kh@harvard.edu").name should be(
          "Kevin Huang"
        )
        new UniversityEmployee(
          "John Doe",
      ...
      "have a email property" in {
        new UniversityEmployee(
          "Mike Stone",
          "mstone@harvard.edu"
        ).email should be("mstone@harvard.edu")
        new UniversityEmployee("Kevin Huang", "kh@harvard.edu").email should be(
          "kh@harvard.edu"
        )
        new UniversityEmployee(
          "John Doe",
          "johndoe@harvard.edu"
        ).email should be("johndoe@harvard.edu")
      }
